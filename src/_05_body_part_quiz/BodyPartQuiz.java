...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if (guess.equalsIgnoreCase("arnold")) {
			...
			JOptionPane.showMessageDialog(null, "No, this is Arnold.");
		}
		// 6. Otherwise:
		...
		if (guess2.equalsIgnoreCase("jack")) {
			...
			JOptionPane.showMessageDialog (null, "No, this is Jack.");
		}
		showNextImage ();
		...
		if (guess3.equalsIgnoreCase("leonardo")) {
			...
			JOptionPane.showMessageDialog(null, "No, this is Leonardo.");
		}
		showNextImage ();
		...
		if (guess4.equalsIgnoreCase("morgan")) {
			...
			JOptionPane.showMessageDialog(null, "No, this is Morgan.");
		}
